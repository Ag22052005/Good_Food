...
function Transaction({transaction}) {
  ...
  return (
  <li className="d-flex border p-2 justify-content-around align-items-center m-1" style={{'minHeight':'8rem'}}>
    <div className="w-75 d-flex justify-content-around flex-column">
    <h5>{transaction.status.toUpperCase()}</h5>
    <p className="" style={{'maxHeight':'24px','overflow':'hidden'}} onClick={(e)=>handleItemNames(e)}>
      {
    ...
    <div className="d-flex justify-content-center h-100 align-items-center" style={{'width':'20%'}}>
